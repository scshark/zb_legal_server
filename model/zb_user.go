...
type ZbUser struct {
      gorm.Model
      UUID  string `json:"uuid" form:"uuid" gorm:"column:uuid;comment:'uuid';type:varchar(255)"`
      ...
      Province  string `json:"province" form:"province" gorm:"column:rovince;comment:'省';type:varchar"`
      City  string `json:"city" form:"city" gorm:"column:city;comment:'市';type:varchar"`
